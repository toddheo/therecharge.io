    ...
    <Container>
      ...
      <Content id="rechargeSection2">
        <div className="second">
          <div className="theme text Roboto_50pt_Black_Mobile">Utility</div>
          <div className="line">
            <Line />
          </div>
          <div className="subTheme text Roboto_40pt_Black">
            Recharge Utilities at a glance
          </div>
          <div className="desc">
            <div className="tier">
              <div className="box" style={{ height: "520px" }}>
                <div className="title text Roboto_30pt_Black">Ecosystem</div>
                <div className="line"></div>
                <div className="text text Roboto_25pt_Regular_Mobile3">
                  Governance
                </div>
                <div className="text text Roboto_25pt_Regular_Mobile3">
                  Token Swap
              ...
              <div className="box" style={{ height: "520px" }}>
                <div className="title text Roboto_30pt_Black">
                  Services Payment
                </div>
                <div className="line"></div>
                <div className="text text Roboto_25pt_Regular_Mobile3">
            ...
            <div className="tier">
              ...
              <div className="box" style={{ height: "350px" }}>
                <div className="title text Roboto_30pt_Black">Reward</div>
                <div className="line"></div>
                <div className="text text Roboto_25pt_Regular_Mobile3">
                  Service Point
                </div>
            ...
            <div className="tier">
              <div className="box" style={{ height: "320px" }}>
                <div className="title text Roboto_30pt_Black">Lifestyle</div>
                <div className="line"></div>
                <div className="text text Roboto_25pt_Regular_Mobile3">
                  {"F&B"}
                </div>
          ...
          {/* <div className="notice text Roboto_25pt_Regular_Mobile3">
